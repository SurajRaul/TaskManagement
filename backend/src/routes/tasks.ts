...
const validateTask = [
    ...
    check('type').not().isEmpty().withMessage('Task type is required').isString().withMessage('Task type must be a string'),
    check('project').not().isEmpty().withMessage('Project is required').isString().withMessage('Project must be a string'),
];
